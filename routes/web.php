...
Route::get('/', function () {
    return view('single_pages/welcome');
});

Route::get('single_pages/prodotti', function () {
    $data = [
        [
    ...
    return view('single_pages/prodotti', compact('data'));
});

Route::get('single_pages/contatti', function () {
    return view('single_pages/contatti');
});